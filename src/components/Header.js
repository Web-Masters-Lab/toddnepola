      ...
      <nav className="flex mt-5 items-center justify-center" aria-label="Global">
        <div className="flex lg:flex-1 mr-auto">
          <Link className="flex" href="/">
            ...
            <div className='hidden md:grid font-roboto_condensedBold text-white pl-8 my-0'>
              <span className='md:text-6xl lg:text-7xl'>TODD</span>
              <span className='md:text-7xl lg:text-8xl'>NEPOLA</span>
            </div>
          </Link>
        </div>
