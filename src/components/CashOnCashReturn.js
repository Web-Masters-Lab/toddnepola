...
export const CashOnCashReturn = () => {
  ...
  return (
    <section className='container mx-auto'>
      <div className='flex flex-col bg-gray-200 lg:grid lg:grid-cols-2 gap-8 py-4 w-full border-y-2 lg:border-x-2 lg:bg-white  border-primary lg:rounded-2xl my-14'>
