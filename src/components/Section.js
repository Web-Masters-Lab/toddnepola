    ...
    return(
        <div className="bg-[url('/images/ft-lauderdale_beach2.png')] relative h-full bg-cover bg-center bg-no-repeat w-full py-24 sm:py-32">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="-mx-6 grid h-36 grid-cols-2 gap-0.5 overflow-hidden sm:mx-0 md:grid-cols-3">
              
              <a href='/workshop' className="z-0 relative group rounded hover:text-white text-black  bg-[url('/images/ft-lauderdale_beach.webp')] bg-cover bg-no-repeat bg-center">
              ...
              <a href="/book" className="z-0 relative group rounded  hover:text-white text-black  bg-[url('/images/business_background.jpg')] bg-cover bg-no-repeat bg-center bg-primary">
              ...
              <a href="/free-chapter" className="z-0 relative group rounded  hover:text-white text-black  bg-[url('/images/ft-lauderdale_beach3.webp')] bg-cover bg-no-repeat bg-bottom bg-primary">
            ...
            <div className=" mt-0.5 grid gap-0.5 grid-cols-1  overflow-hidden sm:mx-0 ">
